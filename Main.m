...
ionizing_radiation = input('Enter ionizing radiation in Gy: ');
initial_atm = ATM_fnc(ionizing_radiation);
initial_atr = ATR_fnc(ionizing_radiation);
